...
class VmListAttributesTest(unittest.TestCase):
    ...
    def test_view_model_list_attributes(self):
       ...
       self.assertEqual(vm.create_json("'Raum'"), json.dumps({"name": "Raum", "attributes": [{"name": "det1", "typ": "textfield", "mandatory": 0}, {"name": "det2", "typ": "number", "mandatory": 1}, {"name": "det3", "typ": "date", "mandatory": 1}, {"name": "det4", "typ": "dateAndTime", "mandatory": 0}]}))
       # warumm "'Raum'"
